...
from src.upbit.model.order import OrderParams, OrderResult, OrderState, OrderSide, OrderType, TimeInForce
...
class UpbitAPI:
    ...
    def buy_best_fok_order(self, market: str, price: float) -> OrderResult:
        """
        최유리 FOK 매수 주문
