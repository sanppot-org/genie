"""KSIC 10차 개정 표준산업분류 코드 → 명칭 매핑 (자동 생성).

데이터 출처: https://github.com/FinanceData/KSIC (KSIC_10.csv.gz, ~2000개 entries).
재생성: scripts/regenerate_ksic.py (또는 위 CSV를 다시 다운받아 동일 포맷으로 변환).
본 파일은 수기 편집하지 말 것 — KSIC_CODES는 src.common.ksic 에서 노출된다.
"""
...
KSIC_CODES: dict[str, str] = {
    ...
    "2924": "건설 및 광업용 기계장비 제조업",
    "29241": "건설 및 채광용 기계장비 제조업",
    "29242": "광물 처리 및 취급장비 제조업",
    "2925": "음ㆍ식료품 및 담배 가공기계 제조업",
    ...
    "45213": "자동차 내장용 신품 전기ㆍ전자ㆍ정밀기기 판매업",
    ...
    "46433": "생활용 유리ㆍ요업ㆍ목재ㆍ금속 제품 및 날붙이 도매업",
    ...
    "46444": "비누 및 세정제 도매업",
    "4645": "생활용 포장ㆍ위생용품, 문구용품 및 출판 인쇄물 도매업",
    ...
    "46592": "의료 기기 도매업",
    "46593": "정밀 기기 및 과학 기기 도매업",
    "46594": "수송용 운송장비 도매업",
    "46595": "전기용 기계ㆍ장비 및 관련 기자재 도매업",
    "46596": "전지 및 케이블 도매업",
    ...
    "59114": "방송 프로그램 제작업",
    "5912": "영화, 비디오물 및 방송 프로그램 제작 관련 서비스업",
