...
def run_migrations_offline() -> None:
    ...
    """
    # Get database URL from config or alembic.ini
    ...
    if url is None:
        try:
            ...
            # If config fails, use a placeholder URL for autogenerate
...
def run_migrations_online() -> None:
    ...
    if "sqlalchemy.url" not in configuration or configuration["sqlalchemy.url"] == "driver://user:pass@localhost/dbname":
        try:
            ...
            # If config fails, use a placeholder URL for autogenerate
            configuration["sqlalchemy.url"] = "postgresql://user:pass@localhost/dbname"
